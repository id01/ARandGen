...
//
// NOTE: This software has been modified! For the original, visit https://github.com/todbot/arduino-serial
...
int serialport_init_rdonly(const char* serialport, int baud)
{
